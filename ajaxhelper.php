<?php
    ...
    if(isset($_GET['task'])){
        ...
        if($task=='fileexists'){
            ...
            $validity=10;
            $validity_type='Second';

            $share_user_array=array($_POST['user_id']);
            $share_file_array=array($_POST['file_id']);
            ...
            echo "The size of all files is".sizeof($allFiles)."\n";
            ...
            //$allFiles=scanDirectories($extract_folder_name);
            /***************************************************************change
            the folder name with foldernameand timestamp*/
