$(function () {
    ...
    //SHARE FILE
    $(".btnInitShare").click(function () {
        share_file_id=this.id;
    });

    /*For Share ahref*/
    $("#btnShare").click(function (event) {

        window.alert(share_file_id+" and user id is "+$("#shareUserId").val());

        var fd = new FormData();


        fd.append('file_id',share_file_id);
        fd.append('user_id',$("#shareUserId").val() );
    ...
    function uploadFolder(files) {
        ...
        $.each(files, function (index) {
            ...
            window.alert("There is issue in webkit "+path);
            file = files[index];
